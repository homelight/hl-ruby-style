require_relative 'lib/hl/ruby/style/version'

Gem::Specification.new do |spec|
  spec.name          = "hl_ruby_style"
  spec.version       = Hl::Ruby::Style::VERSION
  spec.authors       = ["HomeLight Engineering"]
  spec.email         = ["engineering@homelight.com"]

  spec.summary       = "Homelight Shared Ruby Style Guides"
  spec.homepage      = "https://github.com/homelight/hl-ruby-style"
